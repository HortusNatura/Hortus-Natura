...
/*function wpcf7_recaptcha_render_callback() {
    $service = WPCF7_RECAPTCHA::get_instance();
    ...
    echo '<div class="g-recaptcha" data-sitekey="' . esc_attr( $service->get_sitekey() ) . '"></div>';
}
...
function wpcf7_recaptcha_add_form_tag_recaptcha() {
    ...
    wpcf7_add_form_tag( 'recaptcha', 'wpcf7_recaptcha_render_callback', array( 'display-block' => true ) );
}*/
