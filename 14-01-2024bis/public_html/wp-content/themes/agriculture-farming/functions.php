...
/*captcha
function my_custom_form_captcha() {
    echo '<div class="g-recaptcha" data-sitekey="6Lf1cTQpAAAAAIRY9epb3dqBse15pvPWZn7gUY-R"></div>';
}

add_action('your_form_hook', 'my_custom_form_captcha');*/
